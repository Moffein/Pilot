...
namespace Pilot.Modules
{
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add(prefix + "SUBTITLE", "Airborne Assailant");
            ...
            LanguageAPI.Add(prefix + "PRIMARY_DESCRIPTION", "Fire your weapon for <style=cIsDamage>100% damage</style>. Every third hit <style=cIsDamage>pierces</style> and deals <style=cIsDamage>200% damage</style>.");

            LanguageAPI.Add(prefix + "PRIMARY_ALT_NAME", "Rapidfire");
            LanguageAPI.Add(prefix + "PRIMARY_ALT_DESCRIPTION", "Rapidly fire your weapon for <style=cIsDamage>80% damage</style>.");
        }
    }
}