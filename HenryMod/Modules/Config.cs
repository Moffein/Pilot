...
namespace MoffeinPilot.Modules
{
    public static class Config
    {
        public static void ReadConfig()
        {
            ...
            EntityStates.MoffeinPilot.Parachute.DeployParachute.cameraMode = PilotPlugin.instance.Config.Bind("Controls", "Rapid Deployment - Camera Mode", EntityStates.MoffeinPilot.Parachute.DeployParachute.CameraModes.Shoulder, "Camera position while using this skill.");
